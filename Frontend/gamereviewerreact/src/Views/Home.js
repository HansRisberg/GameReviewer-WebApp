    ...
    <div>
      ...
      <div className="home-container">
        <div className="carousel_infoCard-container">
          <h3 className="info-container1" style={{ marginLeft: 40 }}> Discover the ultimate gaming companion with our app! Seamlessly explore a vast array of games using the IGDB database, ensuring you never miss out on the latest hits or hidden gems. Effortlessly search for your favorite titles and uncover new adventures. Share your gaming experiences by writing detailed reviews and reading others' insights. Expand the database by adding new games, making our platform richer for everyone. Create a user account to personalize your experience, track your reviews, and contribute to the gaming community. Dive into a world of endless gaming possibilities with our "intuitive" and comprehensive app!</h3>
          <GameCarousel />
          <h3 className="info-container2" style={{ marginRight: 40 }}> Discover the ultimate gaming companion with our app! Seamlessly explore a vast array of games using the IGDB database, ensuring you never miss out on the latest hits or hidden gems. Effortlessly search for your favorite titles and uncover new adventures. Share your gaming experiences by writing detailed reviews and reading others' insights. Expand the database by adding new games, making our platform richer for everyone. Create a user account to personalize your experience, track your reviews, and contribute to the gaming community. Dive into a world of endless gaming possibilities with our intuitive and comprehensive app!</h3>
        </div>
